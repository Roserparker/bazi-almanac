...
;(function (root) {
  ...
  // 调候用神表（日干 × 月支 → 用神天干，主用在前）· 依《穷通宝鉴 / 造化元钥》（参考，关键格已对原文）
  var TIAOHOU = {
    甲: { 寅: '丙癸', 卯: '庚丙丁', 辰: '庚丁壬', 巳: '癸丁庚', 午: '癸丁庚', 未: '癸丁庚', 申: '丁庚', 酉: '庚丁丙', 戌: '庚甲丁壬', 亥: '庚丁丙戊', 子: '丁庚丙', 丑: '丁庚丙' },
    ...
    庚: { 寅: '丙甲戊壬', 卯: '丁甲庚丙', 辰: '甲丁壬癸', 巳: '壬戊丙丁', 午: '壬癸', 未: '丁甲', 申: '丁甲', 酉: '丁甲丙', 戌: '甲壬', 亥: '丁丙', 子: '丁丙甲', 丑: '丙丁甲' },
